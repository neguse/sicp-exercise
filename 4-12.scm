...
; 4.11で抽象度が低くて苦しんだのをなんとかしてくれという問題。
; こういうだめなコードをリファクタリングしてくれ的なやつ、仕事ならしかたなくやるけど
; 趣味でやるのはいやだなぁ。

; ということで、適当にcarとかcdrとか使ってる箇所をそれっぽい関数におきかえるだけやっておいた。
; やっぱりテストあるとリグレッション気にせずにこういうのできていいですね。
