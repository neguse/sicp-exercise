...
(define wave-segments
 (list
  (make-segment
   (make-vect 0.430 0.830)
   (make-vect 0.460 0.830))
  (make-segment
   (make-vect 0.530 0.830)
   (make-vect 0.570 0.830))
  (make-segment
   (make-vect 0.470 0.730)
   (make-vect 0.530 0.730))
  (make-segment
...
(define (square-limit painter n)
  (let ((combine4 (square-of-four identity flip-horiz
                                  flip-vert rotate180)))
    (combine4 (corner-split-mod painter n))))
